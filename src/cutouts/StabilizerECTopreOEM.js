...
/**
 * EC stabalizer cutouts for OEM housings (also supports Densus/KLC's)
 * Dimensions [width * height] of spacebar stabilizer housing cutouts are as follows:
 * Spacebar stab housing: 13.462mm * 13.741mm
 */

export class StabilizerECTopreOEM extends CutoutGenerator {
